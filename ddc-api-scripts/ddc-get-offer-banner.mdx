...
:::info
This document describes how the **Universal SRP Get-Offer Banner** script works on Dealer.com Search Results Pages (SRP).\
...
:::info
This script is designed to run inside the **Dealer.com Web Integration API** environment. It should be loaded via the DDC `APILoader` pattern.
:::
