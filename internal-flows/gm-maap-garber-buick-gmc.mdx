...
The `MAAP_Custom1` export is uploaded to HomeNet via SFTP as part of the inventory/pricing ingest process through a [Make.com](http://Make.com) scenario (https://us1.make.com/138467/scenarios/4511842/edit)
